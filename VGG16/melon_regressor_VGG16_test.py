...
vgg16.load_state_dict(torch.load('melon_regressor_vgg16.pth', map_location=device))
...
# 엑셀로 저장
with pd.ExcelWriter('VGG16_model_evaluation.xlsx') as writer:
...
print("Evaluation results saved to 'VGG16_model_evaluation.xlsx'")
