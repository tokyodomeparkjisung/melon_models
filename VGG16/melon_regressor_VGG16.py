...
def train_vgg16(model, train_loader, val_loader, criterion, optimizer, num_epochs=10):
    ...
    # Save model state
    torch.save(model.state_dict(), 'melon_regressor_vgg16.pth')
    print("Model saved as 'melon_regressor_vgg16.pth'")



# Start training
train_vgg16(vgg16, train_loader224, val_loader224, criterion, optimizer, num_epochs=10)